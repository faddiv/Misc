...
namespace Microsoft.Extensions.DependencyInjection.ServiceLookup
{
    public class CallSiteFactoryTest
    {
        ...
        public static TheoryData<Type, object, Type[]> CreateCallSite_PicksConstructorWithTheMostNumberOfResolvedParametersData =>
            new TheoryData<Type, object, Type[]>
            {
                {
        ...
        {
            Func<Type, ServiceCallSite> callSiteFactory = (Func<Type, ServiceCallSite>)method;
            // Act
            var callSite = callSiteFactory(type);
