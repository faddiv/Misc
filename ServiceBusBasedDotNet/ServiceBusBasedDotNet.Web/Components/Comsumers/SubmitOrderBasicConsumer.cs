...
public class SubmitOrderBasicConsumer : IConsumer<SubmitOrderBasic>
{
    private readonly ILogger<SubmitOrderBasicConsumer> _logger;

    public SubmitOrderBasicConsumer(ILogger<SubmitOrderBasicConsumer> logger)
    {
        _logger = logger;
    }
