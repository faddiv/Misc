...
namespace ExportSerializationHelper.Tests
{
    ...
    public class SamplesController
    {
        ...
        private Columns CreateWorksheetColumns()
        {
            ...
            col.Min = UInt32Value.FromUInt32(1);
            col.Max = col.Min;
            ...
            col.Min = UInt32Value.FromUInt32(2);
            col.Max = col.Min;
            col.CustomWidth = BooleanValue.FromBoolean(true);
            workSheetColumns.Append(col);
            ...
            col.Min = UInt32Value.FromUInt32(3);
            col.Max = col.Min;
            col.CustomWidth = BooleanValue.FromBoolean(true);
            workSheetColumns.Append(col);
            ...
            col.Min = UInt32Value.FromUInt32(4);
            col.Max = col.Min;
            col.CustomWidth = BooleanValue.FromBoolean(true);
            workSheetColumns.Append(col);
            ...
            col.Min = UInt32Value.FromUInt32(5);
            col.Max = col.Min;
            col.CustomWidth = BooleanValue.FromBoolean(true);
            workSheetColumns.Append(col);
            ...
            col = new Column();
            col.Width = DoubleValue.FromDouble(15.0);
            col.Min = UInt32Value.FromUInt32(6);
            col.Max = col.Min;
            col.CustomWidth = BooleanValue.FromBoolean(true);
            workSheetColumns.Append(col);
            ...
            col = new Column();
            col.Width = DoubleValue.FromDouble(15.0);
            col.Min = UInt32Value.FromUInt32(7);
            col.Max = col.Min;
            col.CustomWidth = BooleanValue.FromBoolean(true);
            workSheetColumns.Append(col);
            ...
            col = new Column();
            col.Width = DoubleValue.FromDouble(15.0);
            col.Min = UInt32Value.FromUInt32(8);
            col.Max = col.Min;
            col.CustomWidth = BooleanValue.FromBoolean(true);
            workSheetColumns.Append(col);
        ...
        private Stylesheet CreateStyleSheet()
        {
            ...
            numberingFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_DATETIME);
            ...
            numberingFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_INVOICE_NUMBER);
            styleSheet.NumberingFormats.Append(numberingFormat);

            // this number format is for the quantity
            numberingFormat = new NumberingFormat();
            numberingFormat.FormatCode = StringValue.FromString("#");
            numberingFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_QTY);
            styleSheet.NumberingFormats.Append(numberingFormat);

            // this format is for the unit price and the subtotal columns.
            numberingFormat = new NumberingFormat();
            numberingFormat.FormatCode = StringValue.FromString("$#.00");
            numberingFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_CURRENCY);
            styleSheet.NumberingFormats.Append(numberingFormat);
            ...
            cellFormat.FontId = UInt32Value.FromUInt32((uint)FONTID_RED_BOLD);
            cellFormat.ApplyFont = BooleanValue.FromBoolean(true);
            cellFormat.FillId = UInt32Value.FromUInt32((uint)FILLID_PATTERN_GOLD);
            cellFormat.ApplyFill = BooleanValue.FromBoolean(true);
            cellFormat.BorderId = UInt32Value.FromUInt32((uint)BORDERID_GRAY);
            ...
            // (Date)
            cellFormat = new CellFormat();
            cellFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_DATETIME);
            ...
            // Invoice Number
            cellFormat = new CellFormat();
            cellFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_INVOICE_NUMBER);
            cellFormat.ApplyNumberFormat = BooleanValue.FromBoolean(true);
            cellFormat.Alignment = new Alignment();
            cellFormat.Alignment.Horizontal = HorizontalAlignmentValues.Left;
            cellFormat.Alignment.Vertical = VerticalAlignmentValues.Top;
            ...
            // Qty
            cellFormat = new CellFormat();
            cellFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_QTY);
            cellFormat.ApplyNumberFormat = BooleanValue.FromBoolean(true);
            cellFormat.Alignment = new Alignment();
            cellFormat.Alignment.Horizontal = HorizontalAlignmentValues.Right;
            cellFormat.Alignment.Vertical = VerticalAlignmentValues.Top;
            ...
            // Unit, Total - Currency
            cellFormat = new CellFormat();
            cellFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_CURRENCY);
            cellFormat.ApplyNumberFormat = BooleanValue.FromBoolean(true);
            cellFormat.Alignment = new Alignment();
            cellFormat.Alignment.Horizontal = HorizontalAlignmentValues.Right;
            cellFormat.Alignment.Vertical = VerticalAlignmentValues.Top;
            ...
            cellFormat.NumberFormatId = UInt32Value.FromUInt32((uint)NUMBERING_FORMAT_CURRENCY);
            cellFormat.ApplyNumberFormat = BooleanValue.FromBoolean(true);
            cellFormat.FontId = UInt32Value.FromUInt32((uint)FONTID_DEFAULT_BOLD);
            cellFormat.ApplyFont = BooleanValue.FromBoolean(true);
            cellFormat.FillId = UInt32Value.FromUInt32((uint)FILLID_PATTERN_GREEN);
            cellFormat.ApplyFill = BooleanValue.FromBoolean(true);
            cellFormat.BorderId = UInt32Value.FromUInt32((uint)BORDERID_GRAY);
            cellFormat.ApplyBorder = BooleanValue.FromBoolean(true);
            cellFormat.Alignment = new Alignment();
        ...
        private void CreateHeaderDataRow(Row rw)
        {
            ...
            c.StyleIndex = UInt32Value.FromUInt32((uint)HEADER_CELLSTYLE_LEFT_JUSTIFIED);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((uint)HEADER_CELLSTYLE_RIGHT_JUSTIFIED);
        ...
        private void CreateDataRow(DataItem itm, Row rw)
        {
            ...
            c.StyleIndex = UInt32Value.FromUInt32((uint)DATA_CELLSTYLE_INVOICE_NUMBER);
            c.CellReference = "A" + rw.RowIndex.ToString();
            rw.Append(c);
            ...
            c.StyleIndex = UInt32Value.FromUInt32((uint)DATA_CELLSTYLE_DATE);
            c.CellReference = "B" + rw.RowIndex.ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((uint)DATA_CELLSTYLE_TEXT);
            c.CellReference = "C" + rw.RowIndex.ToString();
            rw.Append(c);
            ...
            c.StyleIndex = UInt32Value.FromUInt32((uint)DATA_CELLSTYLE_WILL_PICKUP);
            c.CellReference = "E" + rw.RowIndex.ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.Number;
            c.StyleIndex = UInt32Value.FromUInt32((uint)DATA_CELLSTYLE_QTY);
            c.CellReference = "F" + rw.RowIndex.ToString();
            rw.Append(c);
            Cell QtyCell = c;
            ...
            c.DataType = CellValues.Number;
            c.StyleIndex = UInt32Value.FromUInt32((uint)DATA_CELLSTYLE_CURRENCY);
            c.CellReference = "G" + rw.RowIndex.ToString();
            rw.Append(c);
        ...
        private void CreateFooterRow(int BeginRow, int DataItemCount, Row rw)
        {
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((uint)CELLSTYLE_DEFAULT);
            c.CellReference = "A" + rw.RowIndex.ToString();
            rw.Append(c);
            ...
            c.DataType = CellValues.String;
            c.StyleIndex = UInt32Value.FromUInt32((uint)FOOTER_CELLSTYLE_TOTAL_LABEL_TEXT);
            c.CellReference = "G" + rw.RowIndex.ToString();
            rw.Append(c);
            Cell UnitPriceCell = c;
            ...
            c.CellFormula = cellFormula;
            c.DataType = CellValues.Number;
            c.StyleIndex = UInt32Value.FromUInt32((uint)FOOTER_CELLSTYLE_TOTAL_CURRENCY);
            c.CellReference = "H" + rw.RowIndex.ToString();
            rw.Append(c);
        ...
        private List<DataItem> CreateDataSet()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                itm.Qty = RND.Next(1, 100);
                itm.UnitPrice = RND.Next(11, 39);
