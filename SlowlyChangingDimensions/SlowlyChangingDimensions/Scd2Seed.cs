...
{
    public class Scd2Seed
    {
        public static void Seed()
        {
            var bog = new Faker<ScdExampleTable2>()
                .UseSeed(1000)
                ...
                .Ignore(e => e.EndTimestamp)
                .Ignore(e => e.IsCurrentVersion);
            ...
            db.ScdExampleTable2.AddRange(startList);
            db.SaveChanges();
            ...
            for (int i = 0; i < 365*10; i++)
            {
                ...
                foreach (var element in elements)
                {
                    ...
                    db.ScdExampleTable2.Add(newElement);
                    counter++;
                    if (counter == 500)
                    {
                        db.SaveChanges();
